...
(function(i, V, l, n) {
    var j = function(e) {
        ...
        function ya(a) {
            ...
            var b="<select size='1'"+"name='"+a.sTableId+"'"+"_length class='span6'>",
            c,
            d,
            g = a.aLengthMenu;
            ...
            g.className = a.oClasses.sLength+" span6";
            
            //修改文本与下拉框对齐
            g.innerHTML = "<label class='form-horizontal span3 pull-right'>" + a.oLanguage.sLengthMenu.replace("_MENU_", b) + "</label>";
